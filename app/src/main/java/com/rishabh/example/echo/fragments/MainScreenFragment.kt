...
import com.rishabh.example.echo.adapters.MainScreenAdapter
import java.util.*
...
class MainScreenFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val action_sort_ascending = prefs?.getBoolean("action_sort_ascending", true)
        val action_sort_recent = prefs?.getBoolean("action_sort_recent", false)
        if(getSongsList?.isEmpty() as Boolean){
            ...
            if(action_sort_ascending as Boolean){
                Collections.sort(getSongsList, Songs.Statified.nameComparater)
                _mainScreenAdapter?.notifyDataSetChanged()
            }else if(action_sort_recent as Boolean){
